            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="deduction_add.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="id" name="deduccionId" minlength="4" maxlength="4"  title="Debe ser numérico" required pattern="[0-9]+" />
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="deduction_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_deduccionId" name="deduccionId" minlength="4" maxlength="4"  title="Debe ser numérico" required pattern="[0-9]+" />
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="deduction_delete.php">
                ...
                <div class="text-center">
                    <p>¿DESEA ELIMINAR ESTA DEDUCCIÓN?</p>
